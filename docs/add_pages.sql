...
-- 2. Create a specific trigger function for the pages table
...
DROP TRIGGER IF EXISTS set_pages_updated_at_trigger ON pages;

-- Create the new trigger using the specific function
CREATE TRIGGER set_pages_updated_at_trigger
BEFORE UPDATE ON pages
FOR EACH ROW
EXECUTE PROCEDURE set_pages_updated_at();
...
VALUES ('about', 'About Us', '{
    ...
    "missionText": "<p>To provide our customers with the highest quality, freshest products sourced from local farms and trusted suppliers, all while offering a convenient and delightful shopping experience.</p>",
    "teamTitle": "Meet Our Team",
    "team": [
        { "name": "John Doe", "role": "CEO & Founder", "bio": "<p>John is passionate about bringing fresh, local produce to every household. His vision drives our mission.</p>" },
        { "name": "Jane Smith", "role": "Head of Operations", "bio": "<p>Jane ensures that from farm to your door, every step is seamless, efficient, and meets our quality standards.</p>" },
        { "name": "Peter Jones", "role": "Lead Developer", "bio": "<p>Peter is the mastermind behind our user-friendly platform, constantly innovating to improve your shopping experience.</p>" }
    ]
