        ...
        <>
            {settings && (
                <Script 
                    ...
                    onError={() => {
                        toast({ variant: 'destructive', title: 'Script Load Error', description: 'Could not load payment gateway script. Please check your ad-blocker or network and try again.' });
                        setScriptError(true);
                    }}
                />
            )}
            <DialogContent>
                ...
                <div className="py-4 text-center">
                    {isLoading ? (
                        ...
                        <p className='text-destructive'>Failed to load payment gateway. Please check your ad-blocker or network and try again.</p>
                    ) : storeId ? (
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSslPayment} disabled={isLoading || isProcessing || !storeId || !scriptLoaded || scriptError}>
